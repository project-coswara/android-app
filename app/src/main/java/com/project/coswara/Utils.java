...
import static com.project.coswara.Constants.GENERAL_PREFS;
import static com.project.coswara.Constants.REC_COMPLETED_PREFS;
import static com.project.coswara.Constants.REC_TRACK_COMPLETION_PREFS;
...
public class Utils {
    ...
    public static void setTestMode(Context context, boolean val){
        SharedPreferences.Editor editor = context.getSharedPreferences(GENERAL_PREFS, Context.MODE_PRIVATE).edit();
        editor.putBoolean("test_mode", val);
        editor.apply();
    }

    public static boolean isTestModeOn(Context context){
        SharedPreferences preferences = context.getSharedPreferences(GENERAL_PREFS, Context.MODE_PRIVATE);
